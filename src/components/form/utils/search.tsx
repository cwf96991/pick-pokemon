...
const searchStyles = {
    input: 'w-full border border-gray-300 dark:border-gray-700 py-2 px-4 text-lg outline-none text-sm md:text-md text-gray-700 dark:placeholder-gray-400 dark:text-gray-400 rounded-md bg-transparent',
