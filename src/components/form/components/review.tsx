...
const Review = (props: { setPage: Function }) => {
    ...
    return <div className=" md:px-12 md:py-10 md:border px-2 py-2 m-auto mt-10 rounded-lg">
        ...
        <div className="flex">
            ...
            <button
                ...
                className=" mr-4 btn text-red-700 hover:bg-gray-200 dark:hover:bg-gray-800 border-red-700  hover:border-red-800  bg-transparent border focus:outline-none  font-medium rounded-lg text-sm w-auto sm:w-auto px-5 py-2.5 text-center"
            >
                Edit
            </button>
            <button
